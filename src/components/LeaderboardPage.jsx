  ...
  return (
    ...
    >
      <div className="relative flex flex-col items-center justify-center min-h-screen p-4">
        ...
        <h2 className=" text-white font-exo  text-center text-2xl font-semibold mb-4 uppercase tracking-wide">
          Global Leaderboard
        </h2>
        <div className="bg-white/30 border border-white/70 backdrop-blur-md rounded-2xl p-6 w-full max-w-lg shadow-xl overflow-hidden">
